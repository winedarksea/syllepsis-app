...
export const TOKEN_KEYS: readonly string[] = [
  ...
  '--color-todo-pending', '--color-todo-done', '--color-unsorted-badge', '--color-diag-badge',
...
const NORDIC: Theme = {
  ...
  light: {
    ...
    '--color-todo-pending': '#a45a36', '--color-todo-done': '#6f8767', '--color-unsorted-badge': '#a45a36', '--color-diag-badge': '#7a8a6e',
  ...
  dark: {
    ...
    '--color-todo-pending': '#c8754d', '--color-todo-done': '#7aaa68', '--color-unsorted-badge': '#c8754d', '--color-diag-badge': '#8fa07e',
...
const NAVIGATORS_ARCHIVE: Theme = {
  ...
  light: {
    ...
    '--color-todo-pending': '#a87f3c', '--color-todo-done': '#5e7e58', '--color-unsorted-badge': '#a23b32', '--color-diag-badge': '#7a8a6e',
  ...
  dark: {
    ...
    '--color-todo-pending': '#b9763f', '--color-todo-done': '#7aaa68', '--color-unsorted-badge': '#b9763f', '--color-diag-badge': '#7a9070',
